...
INSERT INTO `pokemonteam` VALUES ('170293231890857984','hewwo','blaziken','blaziken',NULL,NULL,NULL,NULL);
...
INSERT INTO `pokestat` VALUES ('blaziken','Blaziken','170293231890857984',1,1,1,1,10,10,10,10,10,10,20,20,20,20,20,20,'M',10);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `team`(IN trainer_id varchar(64), IN team_name_in VARCHAR(64))
BEGIN
...
-- Dump completed on 2019-06-20 13:26:42
