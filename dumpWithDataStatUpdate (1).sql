...
INSERT INTO `pokemonteam` VALUES ('179370789169004546','test','owo','owo1','owo2','owo3','owo4','owo5');
...
INSERT INTO `pokestat` VALUES ('owo','blaziken','179370789169004546',NULL,NULL,NULL,NULL,205,139,73,127,112,70,18,1,4,10,2,16,'M',68),('owo1','blaziken','179370789169004546',NULL,NULL,NULL,NULL,317,134,108,151,88,74,2,4,11,25,12,6,'F',91),('owo2','blaziken','179370789169004546',NULL,NULL,NULL,NULL,202,110,71,74,112,73,3,8,3,1,16,25,'Genderless',66),('owo3','blaziken','179370789169004546',NULL,NULL,NULL,NULL,124,83,61,54,78,52,28,19,12,6,10,30,'F',45),('owo4','blaziken','179370789169004546',NULL,NULL,NULL,NULL,22,20,12,12,10,11,2,23,8,30,21,22,'Genderless',7),('owo5','blaziken','179370789169004546',NULL,NULL,NULL,NULL,273,199,120,203,178,181,11,22,21,1,22,29,'Genderless',90);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `greatestweakness`(IN trainer_id varchar(64), IN team_name_in VARCHAR(64))
BEGIN
	#names of all pokemon on the team
	DECLARE p1 VARCHAR(64);
    DECLARE p2 VARCHAR(64);
    ...
    #getting the pokemon names from the given team
    SELECT pokemon1 FROM pokemonteam WHERE team_trainer = trainer_id AND team_name = team_name_in into p1;
    SELECT pokemon2 FROM pokemonteam WHERE team_trainer = trainer_id AND team_name = team_name_in into p2;
    SELECT pokemon3 FROM pokemonteam WHERE team_trainer = trainer_id AND team_name = team_name_in into p3;
    SELECT pokemon4 FROM pokemonteam WHERE team_trainer = trainer_id AND team_name = team_name_in into p4;
    SELECT pokemon5 FROM pokemonteam WHERE team_trainer = trainer_id AND team_name = team_name_in into p5;
    SELECT pokemon6 FROM pokemonteam WHERE team_trainer = trainer_id AND team_name = team_name_in into p6;
...
BEGIN
    ...
    SELECT pokemon2 FROM pokemonteam where team_trainer=trainer_id_in and team_name = team_name_in into p1nickname;
    SELECT pokemon3 FROM pokemonteam where team_trainer=trainer_id_in and team_name = team_name_in into p1nickname;
    SELECT pokemon4 FROM pokemonteam where team_trainer=trainer_id_in and team_name = team_name_in into p1nickname;
	
    SELECT team_trainer, team_name, p1_nickname, p1, p2_nickname, p2, p3_nickname, p3, p4_nickname, poke_name as p4 FROM
	(SELECT team_trainer, team_name, p1_nickname, p1, p2_nickname, p2, p3_nickname, poke_name as p3, p4_nickname FROM
		(SELECT team_trainer, team_name, p1_nickname, p1, p2_nickname, poke_name as p2, p3_nickname, p4_nickname FROM
			(SELECT team_trainer, team_name, pokemon1 as p1_nickname, poke_name as p1, pokemon2 as p2_nickname, pokemon3 as p3_nickname, pokemon4 as p4_nickname FROM
    ...
    on t7.p4_nickname = t8.nick_name;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2019-06-20 14:52:58
